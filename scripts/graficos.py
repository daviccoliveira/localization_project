...
gt_file = 'ground_truth2.csv'  # Substitua com o caminho real do arquivo
odom_file = 'odometry.2csv'    # Substitua com o caminho real do arquivo
...
# Plotando a Odometry
plt.plot(odom_x, odom_y, label="Odometry", color="red", linestyle="dashed")

# Adicionando rótulos e título
plt.xlabel('Posição X')
plt.ylabel('Posição Y')
plt.title('Comparação entre Ground Truth e Odometry')
